...
const connectionUrl = "mongodb+srv://cluster0-khwxy.mongodb.net/test?retryWrites=true&w=majority";
...
app.post('/newMember', function(req, res){
        ...
        new user({
                        ...
                        moisturizerNight: req.body.moisturizerNight,
        }).save();
